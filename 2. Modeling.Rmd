...
F.test.ind
```
Therefore we reject 0 hypothesis that all types of industry have zero coefficient. 
...
Finally lets make a linear model for each approach and check if there is any significant differences in coefficients between them
