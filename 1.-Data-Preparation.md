...
```
    ...
    ##   `Market Power Index` = col_character(),
    ##   X11 = col_character(),
    ##   X12 = col_character()
    ## )
...
``` r
ggplot(clean, aes(log(mean_pp), mp_index, color=approach)) +
  geom_point(alpha = 0.7, size = 5, shape = 1) +
  theme_minimal()
```
...
It will not be very efficient to categories each of 28k values. Lets
...
```
    ...
    ##    <chr>                                         <chr>       
    ##  1 Specialist cereals, oilseed and protein crops cereals     
    ##  2 Specialist cereals, oilseed and protein crops cereals     
    ##  3 Specialist cereals, oilseed and protein crops cereals     
    ##  4 Specialist cereals, oilseed and protein crops cereals     
    ##  5 General field cropping                        other       
    ##  6 General field cropping                        other       
    ##  7 General field cropping                        other       
    ##  8 General field cropping                        other       
    ##  9 Specialist horticulture indoor                fruits      
    ## 10 Specialist horticulture indoor                fruits
