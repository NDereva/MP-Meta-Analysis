...
classify_industry <- function(non_classified_str) {
  ...
  meat <- c("meat", "pork", "beef", "hog", "poultry", "livestock", "cattle", "paultry")
  ...
  # clean input string a bit
  non_classified_str <- str_to_lower(non_classified_str) %>% 
                            str_trim(side="both")
