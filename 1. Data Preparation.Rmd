...
```
Unfortunately around 2.% of observations is missing
...
Some articles have only one MPI while other multiple estimates
to avoid excessive influence of articles with many MPIs we will use 
